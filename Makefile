...
OBJECTS = main.o subject.o tile.o graphicdisplay.o grid.o level.o textdisplay.o window.o level.o levelZero.o block.o iblock.o jblock.o lblock.o oblock.o sblock.o tblock.o zblock.o
